...
@Service
public class PdfSigningService_working_20251021_0932 {
    ...
    private void addVisualSignaturesToPages(
        ...
        try {
            ...
            for (int i = 0; i < placements.size(); i++) {
                ...
                // If you want larger signature, you can increase the DPI factor
                float pointsPerPixel = 72f / 96f; // Standard conversion (96 DPI screen to 72 DPI PDF)
                float originalWidth = imageData.getWidth() * pointsPerPixel * 1.5f; // 1.5x multiplier for larger size
                ...
                // Check if image fits in the rectangle, if not, scale it down proportionally
                float scale = 1.0f;
                float maxImageHeight = rect.getHeight() * 0.7f; // Use 70% of height for image
                ...
                // Add image using calculated dimensions
                pdfCanvas.saveState();
                ...
                float textAreaTop = imageY - 8; // Leave some space between image and text

                // Start text from the top of text area
    ...
    private void signPdfWithDigitalSignature(
        ...
        System.out.println("🔐 Applying digital signature (invisible)");
        ...
        try {
            ...
            // Create a tiny, invisible rectangle (1x1 pixel) at position 0,0
            ...
            // Don't set any rendering mode - no visual representation
            System.out.println("   ✅ Digital signature set to invisible (1x1 pixel) on page " + primaryPlacement.pageNumber);
            ...
            System.out.println("   ✅ Digital signature applied (invisible)");
